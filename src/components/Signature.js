...
const Signature = () => {
  ...
  return (
    <Wrapper>
      ...
      >
        <path
          d="M38.9993 230C16.4993 166.833 -10.5008 38.9999 33.4992 29.4999C77.4993 19.9998 134.499 82.5 108.499 111C82.4993 139.5 25.4992 139 27.9992 167C30.4993 195 100.999 225.5 140.999 233C180.999 240.5 192.999 185 168.499 179.5C143.999 174 130.499 198 135.499 214C140.499 230 147.499 235.5 161.999 235.5C176.499 235.5 191.299 218 194.499 198C198.499 173 183.999 237.5 196.499 237.5C208.999 237.5 233.999 206.5 231.999 198C229.999 189.5 218.999 224 235.999 237.5C252.999 251 267.499 175 303.499 186.5C339.499 198 294.469 163.109 267.999 206C249.999 235.167 279.999 261 297.999 246C315.999 231 314 179.5 308 214C302 248.5 406.5 414.5 370.5 419.5C334.5 424.5 178 345 222 319"
          stroke="white"
          strokeWidth="15"
          strokeLinecap="round"
        ...
        <path
          fillRule="evenodd"
          clipRule="evenodd"
          d="M381.588 175.552C370.858 171.865 361.482 174.242 354.371 177.338C347.261 180.433 334.152 190.82 334.152 206.033C334.152 221.246 339.466 227.371 346.919 233.255C354.371 239.139 368.339 240.001 380.64 235.65C392.942 231.299 403.882 221.198 405.129 207.411C406.376 193.623 392.317 179.239 381.588 175.552Z"
          stroke="white"
          strokeWidth="15"
        />
        <path
